const CertificateManagerIcon: React.FC = () => (
  <a href="https://aws.amazon.com/certificate-manager/" target="_blank" rel="noopener noreferrer">
    <svg height="48px" width="48px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
      <title>Amazon Certificate Manager</title>
      <defs>
        <linearGradient
          x1="0%"
          y1="100%"
...
export default CertificateManagerIcon;
