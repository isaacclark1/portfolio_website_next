...
export default function Home() {
  return (
    <div className="flex items-center justify-center h-full">
      <div className="flex items-center justify-center lg:flex-row flex-col w-full py-10">
        <div className="xl:max-w-xl max-w-md order-2 lg:order-1">
          ...
          <div className="flex mr-10 gap-2.5 p-2 justify-between items-center mt-5 sm:mt-10">
            <div className="items-center gap-2.5 flex sm:hidden hover:underline">
        ...
        <div className="lg:ml-16 relative lg:h-96 h-56 w-52 order-1 lg:order-2">
          <Image
            src="/IsaacClark.jpeg"
            alt="Picture of Isaac Clark."
            className="relative h-full w-full object-cover rounded-3xl shadow-[0_0_200px] shadow-white z-50"
            priority
            width={529}
            height={888}
          />
